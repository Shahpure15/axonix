...
import { getSocraticWingmanGradient, socraticWingmanColors } from '@/lib/brand-colors';
...
export default function HomePage() {
  ...
  // Don't show content if authenticated (will redirect)
  if (isAuthenticated) {
    return null;
  }

  return (
  <div className="min-h-screen bg-gradient-to-br from-socratic-wingman-100 via-socratic-wingman-200 to-socratic-wingman-300">
      {/* Navigation */}
  <nav className="bg-gradient-to-r from-socratic-wingman-100/95 via-socratic-wingman-200/90 to-socratic-wingman-300/85 backdrop-blur-lg border-b border-socratic-wingman-400/30 shadow-lg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-2">
              <div className="relative">
                <Zap className="h-8 w-8 text-socratic-wingman-700" />
                <div className="absolute -top-1 -right-1 w-3 h-3 bg-socratic-wingman-600 rounded-full animate-pulse"></div>
              </div>
              <span className="text-xl font-bold text-socratic-wingman-800">
                Socratic Wingman
              </span>
            </div>
            <div className="flex items-center space-x-4">
              <Link href="/auth/login">
                <Button variant="ghost" className="text-socratic-wingman-800 hover:bg-socratic-wingman-300/70 border border-transparent hover:border-socratic-wingman-500/50">Login</Button>
              </Link>
              <Link href="/auth/signup">
                <Button className="bg-gradient-to-r from-socratic-wingman-700 to-socratic-wingman-800 hover:from-socratic-wingman-800 hover:to-socratic-wingman-900 text-white shadow-lg shadow-socratic-wingman-700/30 border border-socratic-wingman-800/50">
                  Get Started
                </Button>
              </Link>
            </div>
      ...
      <footer className="bg-white/80 backdrop-blur-md border-t border-purple-200/30 mt-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="text-center">
            ...
            <p className="text-purple-600">&copy; 2025 Socratic Wingman. Empowering learners through intelligent, gamified education.</p>
          </div>
        </div>
      </footer>
    </div>
