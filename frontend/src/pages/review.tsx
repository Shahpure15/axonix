// Mistake interface for type safety
interface Mistake {
  id: string;
  question: string;
  domain: string;
    ...
    <DashboardLayout>
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-axonix-800 axonix-text-shadow flex items-center gap-2">
              <Brain className="h-8 w-8 text-axonix-700" />
              Review Center
            </h1>
